#if MUN_U128_NATIVE || !defined(__GNUC__) || !defined(__x86_64__)
    int untested(char *msg) {
    #if MUN_U128_NATIVE
        sprintf(msg, "skipped: mun_u128 == __uint128_t");
    #else
        sprintf(msg, "skipped: __uint128_t not supported");
    #endif
        return mun_ok;
    }

    export { "mun:u128", &untested }
#else
